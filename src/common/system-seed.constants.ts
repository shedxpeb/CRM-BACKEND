...
export const SYSTEM_ROLE_DEFS = [
  { name: 'Owner', permissions: ['*'] as string[] },
  {
    name: 'Admin',
    permissions: [
      'lead:list', 'lead:read', 'lead:create', 'lead:update', 'lead:delete', 'lead:restore',
      'customer:list', 'customer:read', 'customer:create', 'customer:update', 'customer:delete', 'customer:restore',
      'project:list', 'project:read', 'project:create', 'project:update', 'project:delete', 'project:restore',
...
export const LEAD_PIPELINE = [
  ...
  { status: 'Rejected', label: 'Rejected', order: 9, isInitial: false, isFinal: true, allowedTransitions: [] as string[], color: '#ef4444' },
  { status: 'Converted', label: 'Converted', order: 10, isInitial: false, isFinal: true, allowedTransitions: [] as string[], color: '#14b8a6' },
];
...
export const CUSTOMER_PIPELINE = [
  ...
  { status: 'Archived', label: 'Archived', order: 3, isInitial: false, isFinal: true, allowedTransitions: [] as string[], color: '#6b7280' },
];
...
export const PROJECT_PIPELINE = [
  ...
  { status: 'Completed', label: 'Completed', order: 8, isInitial: false, isFinal: true, allowedTransitions: [] as string[], color: '#22c55e' },
  ...
  { status: 'Cancelled', label: 'Cancelled', order: 10, isInitial: false, isFinal: true, allowedTransitions: [] as string[], color: '#ef4444' },
];

/** Event rules MUST use statuses from pipelines above — single source of truth */
export const EVENT_RULES: Record<string, Array<{ eventType: string; fromStatus: string | null; toStatus: string }>> = {
  lead: [
