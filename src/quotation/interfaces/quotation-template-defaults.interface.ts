...
We hope you will find the same in order, awaiting your kind reply & esteemed order.`,
  ...
  primaryStructuralMembers: ['Built-up Sections', 'Hot Rolled Beam/Channel'],

  secondaryStructuralMembers: ['Cold Form Z/C Purlins', 'Cold Form Eave Strut', 'Bracing System'],
  ...
  paymentTerms:
    '30 % advance with your confirm Work Order, 30 % against GA drawing approval, 35 % against dispatch of structure from our work shop, 05 % after Handover the Project.\n\nChange orders/revisions will be negotiated separately.',
  ...
  cancellations:
    'Order once placed cannot be cancelled. Cancellation charges will apply as per terms.',

  productionRelease:
    'Production will commence only after receipt of approved GA drawings and advance payment.',

  warranty: 'ONE year warranty against manufacturing defects from date of supply.',

  governingLaw:
    'This contract shall be governed by the laws of Government of India. All disputes shall be subject to arbitration as per Indian Arbitration and Conciliation Act, with venue at Ahmedabad, Gujarat, India.',
